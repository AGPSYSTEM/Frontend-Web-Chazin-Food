        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-[#f8fafc] dark:bg-gray-800/60 border-b border-gray-100 dark:border-gray-800 text-sm font-bold text-[#1e293b] dark:text-gray-200">
              <th className="px-6 py-4 w-[8%] text-left">ID</th>
              <th className="px-6 py-4 w-[22%] text-left">Nombre</th>
              <th className="px-6 py-4 w-[38%] text-left">Descripción</th>
              <th className="px-6 py-4 w-[11%] text-center">Insumos</th>
              <th className="px-6 py-4 w-[11%] text-center">Estado</th>
              <th className="px-6 py-4 w-[10%] text-center">Acciones</th>
            </tr>
          </thead>
